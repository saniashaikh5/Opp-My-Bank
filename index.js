...
class Customer {
    ...
    mobileNumber;
    account;
    constructor(firstNumber, lastName, gender, age, mobileNumber, account) {
...
const customers = [
    ...
    new Customer("Sania", "sheikh", "female", 15, 3235769456, accounts[1]),
    new Customer("Hania", "syed", "female", 34, 3219845854, accounts[2])
];
